...
_SUNGROW_SECRET_RE = re.compile(
    r"!secret\s+(?P<name>sungrow_modbus_host_ip|sungrow_modbus_port|sungrow_modbus_wait_milliseconds|sungrow_modbus_device_address|sungrow_modbus_sbr_device_address|sungrow_modbus_battery_max_power)\b"
)
